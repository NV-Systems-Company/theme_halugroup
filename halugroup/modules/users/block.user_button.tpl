<!-- BEGIN: main -->
<a title="{GLANG.signin} - {GLANG.register}" class="pa pointer button" data-toggle="tip" data-target="#guestBlock_{BLOCKID}" data-click="y" data-callback="recaptchareset"><i style="font-size:22px;color: #145a8d;" class="fa fa-user" aria-hidden="true"></i><span class="hidden">{GLANG.signin}</span></a>
<!-- START FORFOOTER -->
...
<!-- BEGIN: signed -->
<a title="{USER.full_name}" class="pointer button user" data-toggle="tip" data-target="#userBlock_{BLOCKID}" data-click="y"><i style="font-size:22px;color: #145a8d;" class="fa fa-user-circle-o" aria-hidden="true"></i><span class="hidden">{USER.full_name}</span></a>
<!-- START FORFOOTER -->
