...
<div id="detail">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-xs-24 col-sm-10 text-center">
					<a href="" data-src="{SRC_PRO_LAGE}" data-width="{SRC_PRO_LAGE_INFO.width}" class="open_modal" title="{TITLE}"><img src="{SRC_PRO}" alt="" width="100%" class="img-thumbnail" id="imageproduct"></a>
					<br />
					<!-- BEGIN: adminlink -->
					<p class="tab-pane">
						{ADMINLINK}
	...
	<!-- BEGIN: product_detail -->
		...
		<div role="tabpanel" class="tabs">
			...
			<div class="tab-content panel-body fiximg">
				<!-- BEGIN: tabs_content -->
