...
if( ! nv_function_exists( 'nv_page_dichvu' ) )
{
	...
	function nv_page_dichvu( $block_config )
	{
		...
		if( ! empty( $list ) )
		{
			if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.page_duan.tpl' ) )
			{
				$block_theme = $global_config['module_theme'];
			}
			elseif( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.page_duan.tpl' ) )
			{
			...
			$xtpl = new XTemplate( 'global.page_duan.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks' );
			...
			foreach( $list as $l )
			{
				...
				if (!empty($l['image'])) {
                if (file_exists(NV_ROOTDIR . '/' . NV_ASSETS_DIR . '/' . $module . '/' . $l['image'])) {
                    $l['image'] = NV_BASE_SITEURL . NV_ASSETS_DIR . '/' . $module . '/' . $l['image'];
                } elseif (file_exists(NV_ROOTDIR . '/' . NV_UPLOADS_DIR . '/' . $module . '/' . $l['image'])) {
