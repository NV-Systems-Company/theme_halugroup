...
if( ! nv_function_exists( 'creat_thumbs_flexslider' ) )
{
	function creat_thumbs_flexslider( $id, $homeimgfile, $module_name, $width = 200, $height = 150 )
	{
...
if (! nv_function_exists('nv_block_news_kutegroups')) {
    /**
     * nv_block_config_news_kutegroups()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_news_kutegroups($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_news_kutegroups_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_news_kutegroups_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    /**
     * nv_block_news_kutegroups()
     *
     * @param mixed $block_config
     * @return
     */
    function nv_block_news_kutegroups($block_config)
    {
        global $site_mods;
        ...
        if (isset($site_mods[$module])) {
            ...
            if (!empty($list)) {
				...
				$xtpl->assign('LINK_MODU', NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module);
                ...
                foreach ($list as $l) {
					...
					$l['day'] = nv_date('d', $l['publtime']);
					$l['publtime'] = nv_date('M/Y', $l['publtime']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_news_kutegroups($block_config);
}