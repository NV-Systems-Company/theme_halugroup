      ...
      <script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/mainhalu.js" type="text/javascript"></script>				
      <link href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/lightbox.css" rel="stylesheet" type="text/css" />
